...
LSA(KC_D)           ,LT(1,KC_1)     ,LT(1,KC_2)   ,LT(1,KC_3)    ,LT(1,KC_4)    ,RCS(KC_MINS)    ,C(KC_MINS)        ,        RCS(KC_X)     ,LT(1,MC_TMS_CMP)  ,KC_LBRC     ,KC_RBRC    ,KC_NO        ,KC_NO         ,KC_NO   ,KC_NO   ,
            KC_NO, KC_NO, KC_NO,
LT(-1,KC_F9)        ,C(KC_F10)      ,KC_F10       ,LT(0,KC_F11)  ,LT(0, KC_F5)  ,LT(0, MC_TEST)                     ,        C(KC_Y)       ,C(KC_U)           ,C(KC_I)     ,KC_TAB     ,LT(1,KC_P)   ,LT(2,KC_MINS) ,KC_NO   ,KC_NO   ,
            KC_NO, KC_NO, KC_NO,
...
LT(0, MC_NAV_BKMK)  ,KC_NO          ,LT(0,KC_Z)   ,LT(-1,MC_DEF) ,LT(1,KC_C)    ,LT(1,KC_V)      ,LT(0,KC_B)        ,        C(KC_N)       ,MC_COMMENT        ,C(KC_COMM)  ,C(KC_DOT)  ,MC_UNCMNT    ,KC_NO         ,KC_NO   ,
            KC_NO, KC_NO, KC_NO,
MC_TG_BKMK          ,KC_TRNS        ,KC_TRNS      ,KC_NO         ,KC_TRNS       ,RESET_LAYER_LOCK                   ,        S(KC_ENTER)   ,S(KC_ENTER)       ,KC_NO       ,KC_NO      ,KC_NO        ,KC_NO         ,KC_NO   ,
            KC_NO),
